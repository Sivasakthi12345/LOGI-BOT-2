...
from logi import arq
from logi.services.keyboard import Ikb
from logi.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from logi.services.tasks import _get_tasks_text, all_tasks, rm_task
from logi.services.types import InlineQueryResultCachedDocument
from logi.modules.info import get_chat_info, get_user_info
from logi.modules.music import download_youtube_audio
from logi.utils.functions import test_speedtest
from logi.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Logi Robot ❤️](https://t.me/logi_channel):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/logi_channel"
    try:
        messages = [
            m
