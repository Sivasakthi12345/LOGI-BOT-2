...
from logi.__main__ import STATS, TOKEN, USER_INFO
from logi.modules.sql import SESSION
import logi.modules.sql.userinfo_sql as sql
from logi.modules.disable import DisableAbleCommandHandler
from logi.modules.sql.global_bans_sql import is_user_gbanned
from logi.modules.sql.afk_sql import is_afk, set_afk
from logi.modules.sql.users_sql import get_user_num_chats
from logi.modules.helper_funcs.chat_status import sudo_plus
from logi.modules.helper_funcs.extraction import extract_user
from logi import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = (
        f"<b>╔═━「 Current {dispatcher.bot.first_name} Statistics 」</b>\n"
